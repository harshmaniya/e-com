...
const Orders = () => {
    ...
    return (
        <div className="dark:bg-boxdark">
            ...
            <div class="rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                <ul className="flex space-x-12">
                    <li class="hover:text-blue-500 hover:border-blue-500">All orders</li>
                    <li class="hover:text-blue-500 hover:border-blue-500">Completed</li>
                    <li class="hover:text-blue-500 hover:border-blue-500">Pending</li>
                    <li class="hover:text-blue-500 hover:border-blue-500">Cancel</li>
                </ul>
            </div>
                        ...
                        <tbody>
                            {data?.getAllOrders?.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                        <h5 className="font-medium text-black dark:text-white">
                                            {/* <Image src={item.images[0]} alt="product" width={60} height={60} /> */}
                                            {item.name}
                                        </h5>
                        ...
                        style={{ width: '20px', height: '20px', backgroundColor: itemColor.hexCode, borderRadius: '50%', padding: '10px' }}>
                                    ...
                                    <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                        <div className="flex items-center space-x-3.5">
                                            <button onClick={() => router.push(`/admin/products/view/${packageItem._id}`)} className="hover:text-primary">
                                                <svg
