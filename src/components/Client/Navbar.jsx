        ...
        <div className="bg-gray-200">
            <nav className="flex justify-between items-center container mx-auto py-4 px-34">
                ...
                <ul className='flex text-md text-black '>
                    <li className="mr-10 tracking-widest"><Link href="/">Home</Link></li>
                    <li className="mr-10 tracking-widest"><Link href="/about">About</Link></li>
                    <li className="mr-10 tracking-widest"><Link href="/products">Product</Link></li>
                </ul>
                <ul className='flex text-2xl font-medium text-black'>
                    <li className="mr-10">
                        <Link href="/cart">
                            Cart
                        </Link>
                        <span className="ml-1 mt-1 absolute">
                            ...
                            <span className="relative rounded-full px-1.5 -top-10.5 left-3.5 bg-red text-xs">1</span>
                        </span>
                    </li>
